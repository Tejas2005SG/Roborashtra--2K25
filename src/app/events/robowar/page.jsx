...
const CamWarrior = () => {
  const EventChar = "https://drive.google.com/uc?export=download&id=1waNOOsXld52-6selo6IsKI7qU8_5lUGY"
  return (
    <ImageLoader>
    <div className="Event">
