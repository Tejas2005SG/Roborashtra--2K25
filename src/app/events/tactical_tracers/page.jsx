  ...
  return (
    ...
    <div className="Event blazeMaze">
      <div className="Event-content tractical">
        ...
        <h2 style={{fontWeight: "900"}} className="headContact">For any event related query <br />Contact Chandrakant(Event Head) : 9359142631</h2>
