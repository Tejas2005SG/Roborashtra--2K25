...
const FogComponent = () => {
  ...
  class Fog {
    ...
    create() {
      ...
      canvasRef.current.appendChild(this.me);
      ...
      switch (this.direction) {
        case 0:
          ...
          if (this.x + this.width < 0) {
            this.x = canvasRef.current.clientWidth + this.width;
          }
          break;
        case 1:
          this.x += this.velocity;
          if (this.x + this.width > canvasRef.current.width) {
